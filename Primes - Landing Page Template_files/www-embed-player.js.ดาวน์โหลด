...
g=!0}try{var l=a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(G){l="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(le[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){l=a.fileName;h={ab:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,
...
h.requestTimeMs=b;var l=Ne[c];if(l)a:{var m=h,w=c;if(l.videoId)var G="VIDEO";else if(l.playlistId)G="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:w,scope:G}]}delete Ne[c];Ue(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete T[a]}Sa(T)||
Te()}}
...
;function We(a,b,c){Xe(Ye,{attachChild:{csn:a,parentVisualElement:He(b),visualElements:[He(c)]}})}
function Xe(a,b,c){b.eventTimeMs=c?c:Math.round(L());b.lactMs=De();Qe({endpoint:"log_interaction",payload:b},a)}
...
n(Ag,F);k=Ag.prototype;k.ja=function(a,b){this.f||(Cg(this,a),Dg(this,b),this.A&&Eg(this))};
...
k.l=function(){Lg(this);if(this.m&&this.b&&this.m.destroy)try{this.m.destroy()}catch(b){P(b)}this.W=null;for(var a in this.i)p[this.i[a]]=null;this.da=this.b=this.g=null;delete this.j;delete this.o;F.prototype.l.call(this)};
...
;function Xg(a){F.call(this);this.g=a;this.g.subscribe("command",this.ra,this);this.h={};this.i=!1}
z(Xg,F);k=Xg.prototype;k.start=function(){this.i||this.f||(this.i=!0,Yg(this.g,"RECEIVING"))};
...
Y.prototype.l=function(){Y.u.l.call(this);delete this.b};function bh(a,b,c,d){F.call(this);this.g=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.A=!!a;this.m=v(this.w,this);window.addEventListener("message",this.m)}
n(bh,F);bh.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.g&&a.source!=this.g)&&r(a.data)){try{var b=nc(a.data)}catch(c){return}if(!(null==b||this.A&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=Fa(this.j,b.func))&&this.i(b.func,b.args)}}};
...
bh.prototype.l=function(){window.removeEventListener("message",this.m);F.prototype.l.call(this)};function ch(a,b,c){bh.call(this,a,b,c||N("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
...
k.dispose=function(){gh.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function hh(){F.call(this);this.b=new I;ec(this,x(fc,this.b))}
z(hh,F);hh.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
...
;var Z=u("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Eh(){this.b=N("ALT_PREF_COOKIE_NAME","PREF");var a=Nb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
Eh.prototype.get=function(a,b){Fh(a);Gh(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
Eh.prototype.set=function(a,b){Fh(a);Gh(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
Eh.prototype.remove=function(a){Fh(a);Gh(a);delete Z[a]};
Eh.prototype.clear=function(){for(var a in Z)delete Z[a]};
...
qa(Eh);var Ih=null,Jh=null,Kh=null,Lh={};function Mh(a){Ve(a.payload_name,a.payload,Ye,void 0,void 0)}
...
function Qh(a){var b=a.id;a=df();b=Lh[b];a&&b&&Xe(Ye,{click:{csn:a,visualElement:He(b)}})}
function Rh(a){a=a.ids;var b=df();if(b)for(var c=0;c<a.length;c++){var d=Lh[a[c]];if(d){var e=b,f=Ye;Q("interaction_logging_on_gel_web")?Ve("visualElementShown",{csn:e,ve:He(d),eventType:1},f):Xe(f,{visibilityUpdate:{csn:e,visualElements:[He(d)]}},void 0)}}}
